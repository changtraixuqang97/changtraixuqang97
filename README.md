...
- [OpenBMB/ChatDev](https://github.com/OpenBMB/ChatDev) - Create Customized Software using Natural Language Idea (through LLM-powered Multi-Agent Collaboration) (5 days ago)
...
- [dot-agent/dotagent](https://github.com/dot-agent/dotagent) - Highly hackable components for AI apps or autonomous agents 🤖  (4 weeks ago)
