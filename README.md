...
- [ddiu8081/chatgpt-demo](https://github.com/ddiu8081/chatgpt-demo) - A demo repo based on OpenAI API (gpt-3.5-turbo) (5 days ago)
...
- [TheAppleTucker/backend-GPT](https://github.com/TheAppleTucker/backend-GPT) -  (1 month ago)
